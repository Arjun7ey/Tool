...
const LinkTable = () => {
    ...
    const handleUpload = () => {
        // Ensure that link is a valid URL if digital media is selected
        ...
        formData.append('type', mediaType); // Add media type (digital or print)
        ...
        if (mediaType === 'Print Media') {
            ...
            formData.append('image', image); // Assuming link is a File object for print media
        } else if (mediaType === 'Digital Media') {
            formData.append('link', link); // URL for digital media
        }
        ...
        .then(response => {
            const newTask = {
                ...
                link:link,
                file: response.data.link.image_url,
                type: mediaType, // Add the type of media (digital or print)
    ...
    const handleView = (task) => {
        ...
        MySwal.fire({
            title: task.title,
            html: content,
            showCloseButton: true,  // Show close button at the top-right corner
            showConfirmButton: true, // Hide confirm button
            customClass: {
                container: 'swal-container', // Optional for custom styling
                title: 'swal-title',
...
{(userRole === 'superadmin' || userRole === 'departmentadmin') && (
    ...
    <DialogTitle>Post Link/Image</DialogTitle>
    <DialogContent>
        {!mediaType ? (
