...
const VideoTable = () => {
    ...
    useEffect(() => {
        ...
        fetchData();
    }, [page, itemsPerPage, statusFilter, filterDivision, searchTags]);
            ...
            html: (
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
                    {task.file ? (
                        <div style={{ 
                            maxWidth: '100%', 
                            height: '300px', // Fixed height for the video container
                            ...
                            <video 
                                ...
                                style={{ 
                                    width: '100%', 
                                    height: 'auto', 
                                    objectFit: 'cover' // Ensure the video covers the container while maintaining aspect ratio
                                }} 
                            >
                ...
                <CardContent>
                    <Grid container spacing={2} alignItems="center" wrap="nowrap">
                        ...
                        <Grid item xs={12} sm={4} md={3} container justifyContent="flex-end" alignItems="center">
                            ...
                            <Button className="ControlButton" onClick={handleOpenSettings} sx={{ ml: '8px' }} startIcon={<SettingsIcon sx={{ color: 'black' }} />} />
                        </Grid>
                    </Grid>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        {visibleFields.map((field) => (
                                            ...
                                            >
                                                {getFieldName(field)}
                                                <div className="ResizeHandle" onMouseDown={(e) => handleResizeStart(e, field)} />
                                            </th>
                                        ))}
                                    </tr>
                                </thead>
